...
export default function AccountScreen() {
  ...
  // Profile fields
  const [name, setName] = useState('Food Lover');
  const [email, setEmail] = useState('user@foodgenie.com');
    ...
    showAlert('Logout', 'Are you sure you want to logout?', [
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        onPress: () => {
          // Clear user data
          updatePreferences({ onboardingComplete: false });
          showAlert('Logged Out', 'See you soon!');
        },
      },
    ]);
  };
    ...
    <SafeAreaView edges={['top']} style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Manage your profile & subscriptions</Text>
        </View>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.preferenceItem}>
                  ...
                  <View style={styles.preferenceBadge}>
                    <Text style={styles.preferenceBadgeText}>
                      {preferences.diet
                        ? config.dietOptions.find(d => d.id === preferences.diet)?.emoji
                        : '🍽'}{' '}
                      {preferences.diet
                        ? config.dietOptions.find(d => d.id === preferences.diet)?.label
                        : 'Not set'}
                    </Text>
                  </View>
                </View>
              ...
              <View style={styles.preferenceRow}>
                <View style={styles.preferenceItem}>
                  ...
                  <View style={styles.preferenceBadge}>
                    <Text style={styles.preferenceBadgeText}>
                      {config.spiceLevels.find(s => s.level === preferences.spiceLevel)
                        ?.emoji || '🌶️'}
                    </Text>
                  </View>
                </View>
                ...
                {preferences.allergies.length > 0 && (
                  <View style={styles.preferenceItem}>
                    ...
                    <View style={styles.preferenceBadge}>
                      <Text style={styles.preferenceBadgeText}>
                        {preferences.allergies.length} item(s)
                      </Text>
                    </View>
                  </View>
                )}
                ...
                >
                  <View style={styles.subscriptionCard}>
                    ...
                    <View
                      style={[
                        styles.statusBadge,
                        sub.status === 'paused' && styles.statusBadgePaused,
                      ]}
                    >
                      <Text
                        style={[
                          styles.statusText,
                          sub.status === 'paused' && styles.statusTextPaused,
                        ]}
                      >
                    ...
                    <View style={styles.subscriptionHeader}>
                      <View style={styles.subscriptionTitleArea}>
                        ...
                        {sub.restaurant && (
                          <Text style={styles.subscriptionRestaurant}>
                            {sub.restaurant}
                          </Text>
                        )}
                        {sub.cuisine && (
                          <Text style={styles.subscriptionCuisine}>{sub.cuisine}</Text>
                        )}
                      </View>
        ...
        <Animated.View entering={FadeInDown.delay(400).duration(400)}>
          <View style={styles.section}>
            ...
            <Pressable style={styles.settingsItem}>
              <MaterialIcons name="help" size={22} color={theme.textSecondary} />
              <Text style={styles.settingsItemText}>Help & Support</Text>
              <MaterialIcons name="chevron-right" size={22} color={theme.textMuted} />
            </Pressable>

            <Pressable style={styles.settingsItem}>
              <MaterialIcons name="policy" size={22} color={theme.textSecondary} />
