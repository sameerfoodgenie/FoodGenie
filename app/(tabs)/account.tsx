...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: theme.background, borderRadius: theme.borderRadius.xl, padding: 20, borderWidth: 1, borderColor: theme.border, ...theme.shadows.card },
  ...
  subscriptionCard: { backgroundColor: theme.background, borderRadius: theme.borderRadius.xl, padding: 20, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(251, 191, 36, 0.15)', ...theme.shadows.card },
  ...
  logoutItem: { marginTop: 8, borderColor: 'rgba(239, 68, 68, 0.2)', backgroundColor: 'rgba(239, 68, 68, 0.02)' },
