...
export default function RecommendationsScreen() {
  ...
  const { recommendations, addToCart, decisionMode } = useApp();
  ...
  const handleAddToCart = (dish: typeof recommendations[0]) => {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          ...
          <Text style={styles.headerSubtitle}>
            {decisionMode === 'dishes' ? 'Best dishes for you' : 'Top restaurants nearby'}
          </Text>
        </View>
        <View style={{ width: 44 }} />
      </View>
        ...
        {recommendations.length > 0 && (
          <Animated.View entering={FadeInDown.delay(400).duration(400)}>
            <View style={styles.comboSection}>
              ...
              <Pressable style={styles.buildPlateLink}>
                <Text style={styles.buildPlateText}>
                  👉 Build my plate from this kitchen
                </Text>
              </Pressable>
            </View>
          </Animated.View>
