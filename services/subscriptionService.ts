...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    features: [
      '100 AI Tokens/month',
      'Daily meal plan',
      '5 recipe video unlocks',
      'Basic grocery cart generation',
    ],
  },
  {
    id: 'smart_foodie',
  ...
  },
  {
    ...
    features: [
      ...
      'Premium recipe video unlocks',
      'Advanced grocery planning',
      'Priority AI food chat',
      'Cook booking discount coupons',
    ],
  },
];
